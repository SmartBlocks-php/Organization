define([
    ...
    var View = Backbone.View.extend({
        ...
        renderTasks: function () {
            ...
            var tasks = SmartBlocks.Blocks.Organization.Data.tasks.filter(function (elt) {
...
//            console.log(tasks);
        ...
        registerEvents: function () {
            ...
            base.$el.delegate(".add_task_button_container", "click", function () {
                SmartBlocks.Blocks.Organization.ForceReturn = "#activities/" + base.activity.get('id') + "/tasks";
