    ...
    var View = Backbone.View.extend({
        ...
        render: function () {
            ...
            var template = _.template(SummaryTemplate, {
                ...
                types: SmartBlocks.Blocks.Organization.Data.activity_types
            });
            ...
            base.$el.find(".work_done").html(SmartBlocks.Blocks.Organization.common.getFullTimeString(work_done));
            base.$el.find(".work_todo").html(SmartBlocks.Blocks.Organization.common.getFullTimeString(work_todo));
            base.$el.find(".total_work").html(SmartBlocks.Blocks.Organization.common.getFullTimeString(total_work));
