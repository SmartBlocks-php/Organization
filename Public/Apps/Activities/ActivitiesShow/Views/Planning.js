    ...
    var View = Backbone.View.extend({
        ...
        renderTasksList: function () {
            ...
            for (var k in tasks.models) {
                var task = SmartBlocks.Blocks.Organization.Data.tasks.get(tasks.models[k].get('id'));
        ...
        renderCalendar: function () {
            ...
            base.$el.find(".planning_container").fullCalendar({
                ...
                eventDrop: function (event, jsEvent, ui, view) {
                    ...
                    var task = SmartBlocks.Blocks.Organization.Data.tasks.get(planned_task.get('task').get('id'));
                    if (planned_task) {
                ...
                eventClick: function (event, e) {
                    ...
                    if (planned_task) {
                        ...
                        popup.events.on("saved", function (event) {
                            ...
                            SmartBlocks.events.events.trigger("updated_planned_task");
                        });
                    }
